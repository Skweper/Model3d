...
namespace Prototype.Math
{
    public class Matrix4x4
    {
        ...
        public static Matrix4x4 operator *(Matrix4x4 m1, Matrix4x4 m2)
        {
            ...
            result[0] = m1[0] * m2[0] + m1[1] * m2[4] + m1[3] * m2[12];
            result[1] = m1[0] * m2[1] + m1[1] * m2[5] + m1[3] * m2[13];
            result[2] = m1[0] * m2[2] + m1[1] * m2[6] + m1[3] * m2[14];
            result[3] = m1[0] * m2[3] + m1[1] * m2[7] + m1[3] * m2[15];

            result[4] = m1[4] * m2[0] + m1[5] * m2[4] + m1[7] * m2[12];
            result[5] = m1[4] * m2[1] + m1[5] * m2[5] + m1[7] * m2[13];
            result[6] = m1[4] * m2[2] + m1[5] * m2[6] + m1[7] * m2[14];
            result[7] = m1[4] * m2[3] + m1[5] * m2[7] + m1[7] * m2[15];

            result[8] = m1[8] * m2[0] + m1[9] * m2[4] + m1[11] * m2[12];
            result[9] = m1[8] * m2[1] + m1[9] * m2[5] + m1[11] * m2[13];
            result[10] = m1[8] * m2[2] + m1[9] * m2[6] + m1[11] * m2[14];
            result[11] = m1[8] * m2[3] + m1[9] * m2[7] + m1[11] * m2[15];

            result[12] = m1[12] * m2[0] + m1[13] * m2[4] + m1[15] * m2[12];
            result[13] = m1[12] * m2[1] + m1[13] * m2[5] + m1[15] * m2[13];
            result[14] = m1[12] * m2[2] + m1[13] * m2[6] + m1[15] * m2[14];
            result[15] = m1[12] * m2[3] + m1[13] * m2[7] + m1[15] * m2[15];
